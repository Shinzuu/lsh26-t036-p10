...
// src/data/seed-p10.json
var seed_p10_default = {
  case_id: "PUB-01",
  ...
  comparison: {
    ...
    low_amount_bdt: "5000.00",
    monthly_amount_bdt: "2000.00"
  }
};

// src/lib/dataset.js
var SEED = seed_p10_default;
var REQUIRED = [
  "case_id",
  "opening_balance_bdt",
  "days",
...
function validateCase(kase, where = "") {
  ...
  for (const field of REQUIRED) {
    if (kase[field] === void 0 || kase[field] === null) {
  ...
  for (const field of COMPARISON_REQUIRED) {
    if (c[field] === void 0 || c[field] === null) {
...
var monthOf = (isoDate) => isoDate.slice(0, 7);
function daysInMonth(month) {
  const [y, m] = month.split("-").map(Number);
  return new Date(Date.UTC(y, m, 0)).getUTCDate();
}
var amountOf = (r) => parseFloat(r.amount_bdt);
function monthSummary(kase) {
...
var DEMAND_CHARGE_PAISA = 4200;
var METER_RENT_PAISA = 4e3;
var VAT_PERCENT = 5;
var MONTHLY_FIXED_PAISA = DEMAND_CHARGE_PAISA + METER_RENT_PAISA;
var BASE_PAISA_PER_UNIT = SLABS[0].paisaPerUnit;
function toPaisa(decimalString) {
  if (decimalString === null || decimalString === void 0 || decimalString === "") return 0;
...
function vatOn(energyPaisa) {
  return Math.round(energyPaisa * VAT_PERCENT / 100);
}
function energyCost(unitsBefore, units) {
...
var MAX_PROJECTION_DAYS = 3650;
function projectRunOut({ fromDate, fromBalancePaisa, dailyUnits, monthUnitsBefore = 0 }) {
...
function comparisonDays(kase) {
  ...
  if (c.source && c.source !== "readings") {
    ...
    const days = [];
    for (const m of months) {
      for (let d = 1; d <= daysInMonth2(m); d += 1) {
  ...
  return (kase.days ?? []).filter((d) => wanted.has(monthOf2(d.date)));
}
function compareHabits(kase) {
  const c = kase?.comparison;
  ...
  const sameEnergy = lowSummary.energyPaisa === monthlySummary.energyPaisa && lowSummary.vatPaisa === monthlySummary.vatPaisa;
  const monthsWord = (n) => `${n} month${n === 1 ? "" : "s"}`;
  const fixedSentence = `The low-balance habit paid the monthly demand charge and meter rent in ${monthsWord(lowSummary.monthsCharged)}; recharging on the 1st paid them in ${monthsWord(monthlySummary.monthsCharged)}.`;
  const reason = cheaper === "equal" ? `${fixedSentence} Both habits burn identical energy and VAT on identical consumption, so the two cost exactly the same.` : `${fixedSentence} Energy and VAT are identical on both sides \u2014 the whole ${formatBDT(Math.abs(delta))} difference is those fixed charges, ${Math.abs(lowSummary.monthsCharged - monthlySummary.monthsCharged)} \xD7 ${formatBDT(MONTHLY_FIXED_PAISA)}.`;
  return {
    low: lowSummary,
...
// src/lib/store.js
var CaseContext = (0, import_react.createContext)(null);
function StoreProvider({ children }) {
  const [kase, setCase] = (0, import_react.useState)(SEED);
  ...
  return (0, import_react.createElement)(CaseContext.Provider, { value }, children);
}
function ctx() {
  const v = (0, import_react.useContext)(CaseContext);
...
// src/features/DataSource.jsx
var import_react2 = __toESM(require_react(), 1);
var import_jsx_runtime = __toESM(require_jsx_runtime(), 1);
var MONTH_LABEL = { month: "short", year: "numeric", timeZone: "UTC" };
var formatMonth = (m) => (/* @__PURE__ */ new Date(`${m}-01T00:00:00Z`)).toLocaleDateString("en-GB", MONTH_LABEL);
var formatDate = (d) => (/* @__PURE__ */ new Date(`${d}T00:00:00Z`)).toLocaleDateString("en-GB", {
  day: "numeric",
  month: "short",
  year: "numeric",
  timeZone: "UTC"
});
var formatBDT2 = (n) => `\u09F3${n.toLocaleString("en-GB", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`;
function DataSource({ kase: kaseProp, error: errorProp, onLoad }) {
  const [localCase, setLocalCase] = (0, import_react2.useState)(SEED);
  const [localError, setLocalError] = (0, import_react2.useState)(null);
  const [paste, setPaste] = (0, import_react2.useState)("");
  const [busy, setBusy] = (0, import_react2.useState)(false);
  const [pack, setPack] = (0, import_react2.useState)(null);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", { className: "mx-auto w-full max-w-3xl px-4 pt-6", "aria-labelledby": "household-heading", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "rounded-card border border-ink-300/60 bg-white/70 p-4 dark:bg-ink-900/40", children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex flex-wrap items-baseline justify-between gap-2", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h2", { id: "household-heading", className: "text-lg font-semibold tracking-tight", children: [
        "Household ",
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "font-mono text-accent", children: kase.case_id })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { className: "text-sm text-ink-500", children: [
        kase.days.length,
        " daily readings \xB7 ",
        formatDate(first),
        " to ",
        ...
        " \xB7",
        " ",
        kase.recharges.length,
        " recharges"
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("dl", { className: "mt-3 grid grid-cols-2 gap-x-4 gap-y-1 text-sm sm:grid-cols-4", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("dt", { className: "text-ink-500", children: "Opening balance" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("dd", { className: "font-medium", children: formatBDT2(parseFloat(kase.opening_balance_bdt)) })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("dt", { className: "text-ink-500", children: "Today" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("dd", { className: "font-medium", children: formatDate(kase.today) })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("dt", { className: "text-ink-500", children: "Usual daily use" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("dd", { className: "font-medium", children: [
          kase.usual_daily_units,
          " units"
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("dt", { className: "text-ink-500", children: "Total consumed" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("dd", { className: "font-medium", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { className: "mt-4 text-sm font-medium", children: "Months in this data" }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", { className: "mt-2 flex flex-wrap gap-2", children: summary.months.map((m) => {
      const tags = [];
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
        "li",
        {
          className: `rounded-xl border px-3 py-2 text-sm ${tags.length ? "border-accent/50 bg-accent-soft" : "border-ink-300/60 bg-white/60 dark:bg-ink-900/30"}`,
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "font-medium", children: formatMonth(m.month) }),
            " ",
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "text-ink-500", children: [
              m.units.toLocaleString("en-GB"),
              " units"
            ] }),
            tags.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "mt-1 block text-xs font-medium text-accent", children: tags.join(" \xB7 ") })
          ]
        },
        m.month
      );
    }) }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { className: "mt-2 text-xs text-ink-500", children: [
      "Lightest and heaviest are the months with the least and most units consumed.",
      summary.lateLarge && summary.lateLargeRecharge ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
        " ",
        "Large late recharge: ",
        formatMonth(summary.lateLarge),
        " took",
        " ",
        formatBDT2(summary.lateLargeRecharge.amount),
        " on",
        " ",
        formatDate(summary.lateLargeRecharge.date),
        " \u2014 in the month\u2019s last seven days. Where several months qualify, the largest late recharge wins."
      ] }) : " No month has its largest recharge inside its last seven days."
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("details", { className: "mt-4", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("summary", { className: "cursor-pointer text-sm font-medium text-accent", children: "Load a different household" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "mt-3 space-y-3", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { className: "block text-sm", htmlFor: "case-paste", children: "Paste a case, or the whole published sample file" }),
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex flex-wrap items-center gap-3", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "button",
            {
              ...
              children: busy ? "Loading\u2026" : "Load pasted case"
            }
          ),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { className: "text-sm", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "mr-2 text-ink-500", children: "or a JSON file" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              "input",
              {
                type: "file",
        ...
        pack && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { className: "block text-sm", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "text-ink-500", children: [
            pack.length,
            " cases in that file \u2014 choose one"
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "select",
            {
              ...
              children: pack.map((c) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("option", { value: c.case_id, children: [
                c.case_id,
                " \u2014 ",
                c.days.length,
                " readings"
    ...
    error && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      "p",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "flex-1", children: error }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { type: "button", className: "underline", onClick: () => setLocalError(null), children: "dismiss" })
        ]
      }
    )
  ] }) });
...
// src/features/BalanceChart.jsx
var import_react3 = __toESM(require_react(), 1);

// src/lib/chart-scale.js
...
function linePath(values, { width, height, padding = 0, xDomain, yDomain } = {}) {
...
var WIDE = { w: 960, h: 300, pad: { top: 16, right: 16, bottom: 34, left: 68 }, font: 11, ticks: 5 };
var NARROW = { w: 420, h: 300, pad: { top: 12, right: 10, bottom: 30, left: 48 }, font: 11, ticks: 5 };
function useNarrow() {
  const [narrow, setNarrow] = (0, import_react3.useState)(
...
var formatDay = (d) => (/* @__PURE__ */ new Date(`${d}T00:00:00Z`)).toLocaleDateString("en-GB", {
  day: "numeric",
  month: "short",
  year: "numeric",
  timeZone: "UTC"
});
var formatMonth2 = (m) => (/* @__PURE__ */ new Date(`${m}-01T00:00:00Z`)).toLocaleDateString("en-GB", {
  month: "short",
  timeZone: "UTC"
});
var axisTaka = (paisa) => `\u09F3${Math.round(paisa / 100).toLocaleString("en-GB")}`;
function Stat({ label, value, hint, tone = "default" }) {
  const toneClass = tone === "danger" ? "text-danger" : tone === "ok" ? "text-ok" : "text-ink-900 dark:text-ink-50";
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "min-w-0", children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("dt", { className: "text-xs text-ink-500", children: label }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("dd", { className: `mt-0.5 font-medium tabular-nums ${toneClass}`, children: value }),
    hint ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "mt-0.5 text-xs text-ink-500", children: hint }) : null
  ] });
}
function BalanceChart() {
  ...
  const rows = sim?.rows ?? [];
  const chart = (0, import_react3.useMemo)(() => {
    if (rows.length === 0) return null;
    const { w: VIEW_W2, h: VIEW_H2, pad: PAD2 } = box;
    const PLOT_W2 = VIEW_W2 - PAD2.left - PAD2.right;
    const PLOT_H2 = VIEW_H2 - PAD2.top - PAD2.bottom;
    const balances = rows.map((r) => r.balancePaisa);
    const ticks2 = niceTicks(Math.min(0, ...balances), Math.max(...balances), box.ticks);
    const yDomain = [ticks2[0], ticks2.at(-1)];
    const x2 = linearScale([0, Math.max(rows.length - 1, 1)], [PAD2.left, PAD2.left + PLOT_W2]);
    const y2 = linearScale(yDomain, [PAD2.top + PLOT_H2, PAD2.top]);
    const path2 = linePath(balances, {
      width: PLOT_W2,
      height: PLOT_H2,
      padding: 0,
      ...
      /([ML]) ([\d.-]+) ([\d.-]+)/g,
      (_, cmd, sx, sy) => `${cmd} ${(PAD2.left + Number(sx)).toFixed(2)} ${(PAD2.top + Number(sy)).toFixed(2)}`
    );
    const baseY = y2(Math.max(yDomain[0], 0));
    const area2 = `${path2} L ${x2(rows.length - 1).toFixed(2)} ${baseY.toFixed(2)} L ${x2(0).toFixed(2)} ${baseY.toFixed(2)} Z`;
    const recharges2 = rows.map((r, i) => ({ ...r, i })).filter((r) => r.rechargePaisa > 0);
    const boundaries2 = [];
    let seen = null;
    rows.forEach((r, i) => {
      const m = monthOf2(r.date);
      if (m !== seen) {
        seen = m;
        boundaries2.push({ month: m, i });
      }
    });
    return { x: x2, y: y2, ticks: ticks2, yDomain, path: path2, area: area2, recharges: recharges2, boundaries: boundaries2, baseY, PLOT_W: PLOT_W2, PLOT_H: PLOT_H2 };
  }, [rows, box]);
  if (!kase || rows.length === 0 || !chart) {
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("section", { className: "rounded-card border border-ink-300/60 bg-white/70 p-4 dark:bg-ink-900/40", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("h2", { className: "text-lg font-semibold tracking-tight", children: "Balance, day by day" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "mt-2 text-sm text-ink-500", children: "No readings to rebuild yet. Load a case above and the balance line appears here." })
    ] });
  }
  const { x, y, ticks, path, area, recharges, boundaries, PLOT_W, PLOT_H } = chart;
  const { w: VIEW_W, h: VIEW_H, pad: PAD, font: FONT } = box;
  const activeIndex = hoverIndex ?? (selectedDate ? rows.findIndex((r) => r.date === selectedDate) : -1);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("section", { className: "rounded-card border border-ink-300/60 bg-white/70 p-4 dark:bg-ink-900/40", children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex flex-wrap items-baseline justify-between gap-2", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("h2", { className: "text-lg font-semibold tracking-tight", children: "Balance, day by day" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("p", { className: "text-sm text-ink-500", children: [
        rows.length,
        " days \xB7 ",
        recharges.length,
        " recharges \xB7",
        " ",
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "tabular-nums", children: formatBDT(sim.closingBalancePaisa) }),
        " left on",
        " ",
        formatDay(rows.at(-1).date)
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "mt-1 text-sm text-ink-500", children: "Each day charged at the slab the calendar month has reached. Demand charge and meter rent taken once a month, on that month\u2019s first recharge. VAT is 5% of energy only." }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("figure", { className: "mt-3", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
        "svg",
        {
          ...
          children: [
            ...
            boundaries.map(({ month, i }) => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("g", { children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                "line",
                {
                  x1: x(i),
              ...
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                "text",
                {
                  ...
                  style: { fontSize: FONT },
                  children: formatMonth2(month)
                }
              )
            ] }, month)),
            ticks[0] < 0 || wentNegative ? /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
              "line",
              {
                x1: PAD.left,
                x2: PAD.left + PLOT_W,
            ...
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("path", { d: area, className: "fill-accent/10" }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
              "path",
              {
                d: path,
            ...
            recharges.map((r) => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("g", { children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                "circle",
                {
                  cx: x(r.i),
            ...
            active ? /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("g", { children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
                "line",
                {
                  x1: x(activeIndex),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("figcaption", { className: "mt-2 flex flex-wrap items-center gap-x-4 gap-y-1 text-xs text-ink-500", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { className: "inline-flex items-center gap-1.5", children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "inline-block h-0.5 w-4 bg-accent", "aria-hidden": "true" }),
          "balance"
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { className: "inline-flex items-center gap-1.5", children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "inline-block h-2 w-2 rounded-full bg-ok", "aria-hidden": "true" }),
          "recharge"
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { className: "inline-flex items-center gap-1.5", children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          ...
          "first of the month \u2014 paid ",
          formatBDT(MONTHLY_FIXED_PAISA),
          " demand charge + meter rent"
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { children: "dashed line = month start, where the slab counter resets" })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "mt-4 rounded-card border border-ink-300/60 bg-ink-100/60 p-3 dark:bg-ink-900/60", children: detail ? /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex flex-wrap items-baseline justify-between gap-2", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("h3", { className: "text-sm font-medium", children: formatDay(detail.date) }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("p", { className: "text-xs text-ink-500", children: [
          hoverIndex !== null && !row ? "hovering" : "selected",
          " \xB7 day",
          " ",
          rows.findIndex((r) => r.date === detail.date) + 1,
          " of ",
          rows.length
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("dl", { className: "mt-2 grid grid-cols-2 gap-x-4 gap-y-3 sm:grid-cols-4", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Stat, { label: "Units used", value: `${detail.units}`, hint: "that day" }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          Stat,
          {
            label: "Slab rate charged",
            value: detail.slabParts.length === 0 ? "\u2014" : detail.slabParts.map((p) => `\u09F3${(p.paisaPerUnit / 100).toFixed(2)}`).join(" + "),
            hint: detail.slabParts.length > 1 ? detail.slabParts.map((p) => `${p.units}u`).join(" + ") + " \u2014 crossed a slab boundary" : "per unit"
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          Stat,
          {
            ...
            hint: `${formatMonth2(monthOf2(detail.date))} so far`
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
          Stat,
          {
            ...
            hint: detail.balancePaisa < 0 ? "meter would have cut out" : "closing balance that day"
          }
        )
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("p", { className: "mt-3 border-t border-ink-300/50 pt-2 text-xs text-ink-500", children: [
        "Charged that day: energy ",
        formatBDT(detail.energyPaisa),
        " + VAT",
        " ",
        formatBDT(detail.vatPaisa),
        detail.fixedPaisa > 0 ? ` + ${formatBDT(detail.fixedPaisa)} demand charge and meter rent (first recharge of ${formatMonth2(monthOf2(detail.date))})` : "",
        detail.rechargePaisa > 0 ? ` \xB7 recharged ${formatBDT(detail.rechargePaisa)}` : ""
      ] })
    ] }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "text-sm text-ink-500", children: "Select a day on the chart \u2014 click, or focus it and use the arrow keys \u2014 to see the units used, the slab rate charged, the month\u2019s running total and the closing balance." }) }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("dl", { className: "mt-4 grid grid-cols-2 gap-x-4 gap-y-3 sm:grid-cols-5", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Stat, { label: "Energy", value: formatBDT(sim.totals.energyPaisa) }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Stat, { label: "VAT (5% of energy)", value: formatBDT(sim.totals.vatPaisa) }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
        Stat,
        {
          label: "Fixed charges",
          value: formatBDT(sim.totals.fixedPaisa),
          hint: `${sim.firstRechargeMonths.length} months \xD7 ${formatBDT(MONTHLY_FIXED_PAISA)}`
        }
      ),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Stat, { label: "Recharged", value: formatBDT(sim.totals.rechargedPaisa), tone: "ok" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
        Stat,
        {
...
// src/features/Questions.jsx
var import_react4 = __toESM(require_react(), 1);
var import_jsx_runtime3 = __toESM(require_jsx_runtime(), 1);
var BASE_RATE_PAISA = 463;
...
function daysBetween2(fromIso, toIso) {
...
function Row({ label, hint, paisa, strong = false }) {
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
    "div",
    {
      className: `flex items-baseline justify-between gap-4 py-2 ${strong ? "border-t border-ink-300/60 font-semibold" : ""}`,
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: "min-w-0", children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: strong ? "" : "text-ink-700 dark:text-ink-300", children: label }),
          hint && /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "mt-0.5 block text-xs text-ink-500", children: hint })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { className: "shrink-0 tabular-nums", children: formatBDT(paisa) })
      ]
    }
  );
}
function Questions() {
  const { kase, sim } = useCase();
  const [targetDate, setTargetDate] = (0, import_react4.useState)("");
  const start = (0, import_react4.useMemo)(() => kase && sim ? projectionStart(kase, sim) : null, [kase, sim]);
  const target = targetDate || kase?.target_date || "";
  const runOut = (0, import_react4.useMemo)(() => {
  ...
  const needed = (0, import_react4.useMemo)(() => {
    if (!start || !target) return null;
    if (daysBetween2(start.fromDate, target) < 0) {
  ...
  if (!kase || !sim) {
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("section", { className: "mx-auto w-full max-w-xl px-4 py-8", "aria-busy": "true", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("h2", { className: "text-lg font-semibold", children: "The family's two questions" }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "mt-4 space-y-2", children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "h-20 animate-pulse rounded-card bg-ink-100 dark:bg-ink-700/30" }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "h-32 animate-pulse rounded-card bg-ink-100 dark:bg-ink-700/30" })
      ] })
    ] });
  }
  if (!start) {
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("section", { className: "mx-auto w-full max-w-xl px-4 py-8", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("h2", { className: "text-lg font-semibold", children: "The family's two questions" }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "mt-3 rounded-card border border-dashed border-ink-300/70 px-6 py-8 text-center text-ink-500", children: "No daily readings in this household yet, so there is no balance to project from." })
    ] });
  }
  const parts = needed && !needed.error ? needed : null;
  const sumPaisa = parts ? parts.energyPaisa + parts.higherSlabPaisa + parts.fixedPaisa + parts.vatPaisa : 0;
  const reconciles = parts ? sumPaisa === parts.totalPaisa : false;
  const days = target ? daysBetween2(start.fromDate, target) + 1 : 0;
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("section", { className: "mx-auto w-full max-w-xl px-4 py-8", children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("h2", { className: "text-lg font-semibold", children: "The family's two questions" }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("article", { className: "mt-4 rounded-card bg-white p-5 shadow-sm dark:bg-ink-900/40", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("h3", { className: "text-sm font-medium text-ink-700 dark:text-ink-300", children: "1 \xB7 When does the balance run out?" }),
      runOut?.error ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "mt-2 rounded-xl bg-danger/10 px-4 py-3 text-sm text-danger", children: runOut.error }) : runOut?.runsOutOn ? /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "mt-2 text-2xl font-semibold tracking-tight", children: longDate(runOut.runsOutOn) }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("p", { className: "mt-1 text-sm text-ink-500", children: [
          daysBetween2(start.fromDate, runOut.runsOutOn) + 1,
          " days from",
          " ",
          longDate(start.fromDate),
          "."
        ] })
      ] }) : /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "mt-2 text-2xl font-semibold tracking-tight", children: "Not within the projected period" }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("p", { className: "mt-3 text-xs text-ink-500", children: [
        "Assumes ",
        kase.usual_daily_units,
        " units a day \u2014 the household's usual daily use \u2014 from a balance of ",
        formatBDT(start.fromBalancePaisa),
        " on ",
        longDate(kase.today),
        ", with no further recharge. The slab counter resets on the 1st of each calendar month, so later days in a heavy month cost more."
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("article", { className: "mt-4 rounded-card bg-white p-5 shadow-sm dark:bg-ink-900/40", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("h3", { className: "text-sm font-medium text-ink-700 dark:text-ink-300", children: "2 \xB7 How much must be recharged today?" }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("label", { className: "mt-3 block text-sm", htmlFor: "target-date", children: "To last until" }),
      ...
      needed?.error ? /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "mt-3 rounded-xl bg-danger/10 px-4 py-3 text-sm text-danger", children: needed.error }) : parts ? /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "mt-4 text-3xl font-semibold tracking-tight", children: formatBDT(parts.netRequiredPaisa) }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("p", { className: "mt-1 text-sm text-ink-500", children: [
          "to cover ",
          days,
          " days at ",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "mt-4 text-sm", children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
            Row,
            {
              label: "Energy",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Row, { label: "VAT", hint: "5% of the energy amount only", paisa: parts.vatPaisa }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Row, { label: "Cost of those days", paisa: sumPaisa, strong: true }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
            Row,
            {
          ...
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(Row, { label: "Recharge today", paisa: parts.netRequiredPaisa, strong: true })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
          "p",
          {
            className: `mt-3 text-xs ${reconciles ? "text-ink-500" : "font-medium text-danger"}`,
            children: reconciles ? /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
              "The four parts add up: ",
              formatBDT(parts.energyPaisa),
              " +",
              " ",
              formatBDT(parts.higherSlabPaisa),
              " + ",
              formatBDT(parts.fixedPaisa),
              " +",
              " ",
              formatBDT(parts.vatPaisa),
              " = ",
      ...
      ] }) : /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("p", { className: "mt-4 rounded-card border border-dashed border-ink-300/70 px-6 py-8 text-center text-ink-500", children: "Pick a date to see what today's recharge needs to be." }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("p", { className: "mt-4 border-t border-ink-300/40 pt-3 text-xs text-ink-500", children: [
        "The problem does not define a baseline for \u201Cthe part caused by being in a higher slab\u201D, so this is ours: ",
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("strong", { children: "energy" }),
        " is every projected unit charged at the lowest slab rate (\u09F3",
        (BASE_RATE_PAISA / 100).toFixed(2),
        "), and the",
        " ",
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("strong", { children: "higher-slab part" }),
        " is the real slab-aware cost minus that base \u2014 so the two together are exactly the true energy charge, and the four parts reconcile."
      ] })
    ] })
  ] });
}

// src/features/HabitCompare.jsx
var import_react5 = __toESM(require_react(), 1);
var import_jsx_runtime4 = __toESM(require_jsx_runtime(), 1);
var FIXED_PER_MONTH_PAISA = DEMAND_CHARGE_PAISA + METER_RENT_PAISA;
var MONTH_NAMES = [
  "January",
  "February",
  "March",
...
function HabitCompare({ kase: kaseProp }) {
  ...
  const { result, failure } = (0, import_react5.useMemo)(() => {
    ...
    try {
      ...
      if (r && FIXED_PER_MONTH_PAISA > 0 && Math.abs(r.differencePaisa) % FIXED_PER_MONTH_PAISA !== 0) {
        console.warn(
          `[HabitCompare] difference ${r.differencePaisa} paisa is not a multiple of ${FIXED_PER_MONTH_PAISA} \u2014 recharge timing cannot create an energy saving (R-16).`
        );
      }
  ...
  if (!kase || !comparison) {
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Frame, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "rounded-card border border-dashed border-ink-300/70 px-6 py-10 text-center", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { className: "text-ink-500", children: "No household loaded yet. Load a case to compare the two recharge habits." }) }) });
  }
  if (failure !== null) {
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Frame, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "rounded-xl bg-danger/10 px-4 py-3 text-sm text-danger", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { children: "This household\u2019s data could not be compared \u2014 the comparison months are missing daily readings. Load a complete case to see the two habits." }),
      failure && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("p", { className: "mt-1 text-xs opacity-80", children: [
        "Details: ",
        failure
      ] })
    ] }) });
  ...
  if (!result || result.pending) {
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Frame, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "space-y-2", "aria-busy": "true", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "h-24 animate-pulse rounded-card bg-ink-100 dark:bg-ink-700/30" }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "h-24 animate-pulse rounded-card bg-ink-100 dark:bg-ink-700/30" })
    ] }) });
  }
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Frame, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("header", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("h2", { className: "text-xl font-semibold tracking-tight", children: "Which recharge habit costs less?" }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("p", { className: "mt-1 text-sm text-ink-500", children: [
        "Both habits run over",
        " ",
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("strong", { className: "font-medium text-ink-700 dark:text-ink-100", children: months.map(monthLabel).join(", ") }),
        " ",
        "on the household\u2019s own daily readings \u2014 identical consumption, the same calendar-month slab counter, both starting from",
        " ",
        money(comparison.opening_balance_bdt),
        ". Cost is what the meter consumes: energy, VAT and the monthly fixed charges \u2014 not the amount deposited."
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
      "p",
      {
        className: `mt-5 rounded-card px-4 py-3 text-base font-medium ${equal ? "bg-accent-soft text-ink-900" : "bg-ok/10 text-ink-900 dark:text-ink-50"}`,
        children: equal ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
          "Both habits cost exactly the same \u2014 ",
          formatBDT(result.low.costPaisa),
          " over the ",
          monthCount,
          " months."
    ...
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "mt-4 grid gap-4 sm:grid-cols-2", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
        HabitCard,
        {
    ...
    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("p", { className: "mt-4 rounded-card bg-white px-4 py-3 text-sm leading-relaxed text-ink-700 shadow-sm dark:bg-ink-900/40 dark:text-ink-100", children: [
      "Energy and VAT are identical under both habits \u2014 the same units are burned against the same calendar-month slab counter, so ",
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("em", { children: "when" }),
      " the meter is recharged cannot change the rate a unit is charged at.",
      " ",
      equal ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
        "Both habits triggered a first recharge in all ",
        monthCount,
        " of the ",
        monthCount,
        " months, so both paid the ",
        formatBDT(FIXED_PER_MONTH_PAISA),
        " demand charge and meter rent",
        " ",
        times(monthCount),
        ". The two habits cost the same, and that is the correct answer here \u2014 there is no saving to be had from recharge timing."
      ] }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
        "The whole difference is fixed charges: recharging when low triggered a first recharge in ",
        lowMonths,
        " of the ",
        monthCount,
        " months and recharging monthly in",
        " ",
        monthlyMonths,
        ", so they paid the ",
        formatBDT(FIXED_PER_MONTH_PAISA),
        ...
        " and ",
        times(monthlyMonths),
        " respectively. That is the only source of the ",
        formatBDT(difference),
        "."
      ] })
    ] })
...
function Frame({ children }) {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("section", { "aria-labelledby": "habit-compare-heading", className: "mx-auto w-full max-w-3xl px-4 pb-12 pt-8", children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("h2", { id: "habit-compare-heading", className: "sr-only", children: "Recharge habit comparison" }),
    children
  ] });
}
function HabitCard({ title, rule, habit, monthCount, isCheaper }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
    "article",
    {
      className: `rounded-card bg-white p-4 shadow-sm dark:bg-ink-900/40 ${isCheaper ? "ring-2 ring-ok" : ""}`,
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "flex items-baseline justify-between gap-2", children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("h3", { className: "font-semibold", children: title }),
          isCheaper && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "text-xs font-medium text-ok", children: "cheaper" })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { className: "mt-1 text-xs text-ink-500", children: rule }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("dl", { className: "mt-3 space-y-1 text-sm", children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Row2, { label: "Energy", value: formatBDT(habit?.energyPaisa ?? 0) }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Row2, { label: "VAT (5% of energy)", value: formatBDT(habit?.vatPaisa ?? 0) }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
            Row2,
            {
          ...
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "flex items-baseline justify-between border-t border-ink-300/60 pt-1 font-semibold", children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("dt", { children: "Total cost" }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("dd", { className: "tabular-nums", children: formatBDT(habit?.costPaisa ?? 0) })
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("p", { className: "mt-3 text-xs text-ink-500", children: dates.length === 0 ? "No recharge was triggered in these months." : /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
          dates.length,
          " recharge",
          dates.length === 1 ? "" : "s",
          ":",
          " ",
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "text-ink-700 dark:text-ink-300", children: dates.map(dayLabel).join(" \xB7 ") })
        ] }) })
      ]
    }
  );
...
function Row2({ label, value }) {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "flex items-baseline justify-between gap-2", children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("dt", { className: "text-ink-500", children: label }),
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("dd", { className: "tabular-nums", children: value })
  ] });
}

// src/App.jsx
var import_jsx_runtime5 = __toESM(require_jsx_runtime(), 1);
var APP_NAME = "Recharge Advisor";
var TAGLINE = "Where the prepaid balance actually goes, and what to recharge before it runs out.";
function Layout() {
  const { kase, load, error } = useCase();
  const empty = !kase || !kase.days?.length;
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(import_jsx_runtime5.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("header", { className: "mx-auto w-full max-w-6xl px-4 pt-8 pb-4", children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("p", { className: "text-xs font-medium uppercase tracking-wide text-accent", children: "LSH26-T036 \xB7 Problem P10" }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("h1", { className: "mt-1 text-2xl font-semibold tracking-tight", children: APP_NAME }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("p", { className: "mt-1 text-ink-500", children: TAGLINE })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("main", { className: "mx-auto w-full max-w-6xl px-4 pb-16", children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(DataSource, { kase, error, onLoad: load }),
      empty ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("p", { className: "mt-6 rounded-card border border-ink-300 p-6 text-center text-ink-500", children: "No readings loaded. Paste or upload a case above to begin." }) : /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(import_jsx_runtime5.Fragment, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "mt-6", children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(BalanceChart, {}) }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "mt-6 grid gap-6 lg:grid-cols-2", children: [
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "min-w-0", children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Questions, {}) }),
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "min-w-0", children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(HabitCompare, {}) })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("footer", { className: "mx-auto w-full max-w-6xl px-4 pb-10 text-xs text-ink-500", children: "Team Miasma \xB7 LSH26-T036 \xB7 LofiStack Hackathon 2026" })
  ] });
}
function App() {
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(StoreProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Layout, {}) });
}

// ssr-entry.jsx
var import_jsx_runtime6 = __toESM(require_jsx_runtime(), 1);
var html = (0, import_server.renderToStaticMarkup)(/* @__PURE__ */ (0, import_jsx_runtime6.jsx)(App, {}));
