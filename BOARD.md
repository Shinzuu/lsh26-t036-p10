...
|---|---|---|---|---|---|
| U1 | R1 — household, ≥6 months of daily readings + recharges, light/heavy/late-large months labelled | shinzuu | `u1-household` | pushed | 19:20 — MERGED. Live check pending human pass: opens with 181 readings and 18 recharges, months line labels 2026-01 lightest / 2026-05 heaviest / 2026-05 large late recharge. |
| U2 | R2 — rebuild the balance day by day on the tariff, fixed charges on the month's first recharge, VAT, balance line with recharge markers | Rimjhim | `u2-tariff-engine` | pushed | 19:20 — MERGED `6c30d00`. 52 tests pass repo-wide. compareHabits checked against the SPEC oracle over all 25 fixture cases: 22 equal, 3 differ by exactly 82.00 (PUB-02, PUB-06, PUB-24), energy and VAT identical on both habits in every case, so R-16 holds. |
| U3 | R3 — run-out date, and the amount to recharge today split into energy / higher-slab / fixed / VAT | Robiul | `u3-questions` | pushed | 19:20 — MERGED. Integrator fix on top: the headline now shows netRequiredPaisa (the deposit) rather than the gross cost of the projected days; the balance already on the meter is its own line. |
| U4 | R4 — compare the two recharge habits over three months on identical consumption | Dip | `u4-habit-compare` | pushed | 19:20 — MERGED. Renders R-16/R-33 wording; verdict held while the engine reports pending. |
